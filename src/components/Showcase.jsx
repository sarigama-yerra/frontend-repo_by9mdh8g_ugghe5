          ...
          {products.map((p, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between p-4">
                ...
                <button className="rounded-full bg-gradient-to-r from-cyan-400 to-fuchsia-400 px-4 py-2 text-xs font-semibold text-black transition hover:from-cyan-300 hover:to-fuchsia-300">Add</button>
              </div>
            </motion.div>
          ))}
        </div>
